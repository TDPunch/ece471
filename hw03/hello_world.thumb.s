...
_start:
	...
	mov	r4, #0			@ Initialize counter variable
...
L1:
	...
	mov	r0, r4			@ Add line number to output
	cmp 	r4, #16			@ has it printed 15 times yet?
...
print_string:
	...
	push    {r0,r2,r7,lr}	@ Save r0,r2,r7,r10,lr on stack
